...
<div style="text-align: center;">
  <img src="../../asset/interface/rel_regular.gif" alt="rel_regular" width="70%" />
</div>

If you find multiple objects that match the description, click `Multiple Match` and confirm your guess.
<div style="text-align: center;">
  <img src="../../asset/interface/rel_multiple_match.gif" alt="rel_multiple_match" width="70%" />
</div>

If you cannot find such an object in the image, click `Cannot Tell Where The Object Is` and confirm your guess.
<div style="text-align: center;">
  <img src="../../asset/interface/rel_nomatch.gif" alt="rel_nomatch" width="70%" />
</div>
...
<div style="text-align: center;">
  <img src="../../asset/interface/reg_text.gif" alt="reg_text" width="70%" />
</div>
...
<div style="text-align: center;">
  <img src="../../asset/interface/reg_audio.gif" alt="reg_audio" width="70%" />
</div>
